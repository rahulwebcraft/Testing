...
<div class="cl-entry__media">
    ...
    <div class="cl-entry__gallery">
        ...
        <div id="cl-owl-carousel-<?php the_ID() ?>" class="owl-carousel owl-theme cl-carousel">
                    ...
                    if( is_array( $slider_data ) && ! empty( $slider_data['image_ids'] ) ):
                        foreach( $slider_data['image_ids'] as $attachment_id ):
                            echo '<div class="cl-entry__slide">';
                                echo '<img src="'.codeless_get_attachment_image_src( $attachment_id, codeless_get_post_thumbnail_size() ).'" alt="'.esc_attr__('Slider Image', 'regn').'" />';
