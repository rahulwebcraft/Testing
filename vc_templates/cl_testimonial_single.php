...
$new_query = array( 
    ...
    'post__in' => array( (int) $member ),
    'posts_per_page' => '1'
); 

?>

<div class="cl-element cl-testimonial-single">
    
    <div class="cl-testimonial-single__wrapper">
        ...
        if ( $the_query->have_posts() ) :
            ...
            while ( $the_query->have_posts() ) : $the_query->the_post();
                ...
                <div class="cl-testimonial-item">
                    ...
                    <div class="cl-testimonial-item__author">
                        ...
                        <div class="cl-testimonial-item__data">
            ...
            <div class="cl-testimonial-item"><?php esc_html_e( 'No Testimonials found.', 'regn' ); ?></article>

        <?php endif; ?>                         
        
    </div><!-- .cl-testimonial-single__wrapper -->

</div><!-- .cl-testimonial-single -->
