	...
	@media (min-width:992px){
		<?php if( strpos(  codeless_get_mod( 'main_header_bg_color', '' ), 'rgba' ) !== false ): ?>
	...
	@media (min-width:992px){
		.cl-header{
		 	width:<?php echo esc_attr( codeless_get_mod('header_width') ) ?>px;
		}
			<?php if( ! codeless_is_header_boxed() ): ?>
				...
				#viewport{
			 		...
			 		padding-<?php echo esc_attr( codeless_get_mod('header_layout', 'top') ) ?>: <?php echo (int)esc_attr( codeless_get_mod('header_width') ) . 'px'; ?>
	...
	@media (min-width:992px){
		.cl-header--transparent .cl-header__row--main{
			background-color: <?php echo esc_attr( codeless_get_mod( 'main_header_bg_color', '' ) ); ?> !important;
		}
	}
	<?php endif; ?>

	.cl-team-grid-item:hover .cl-team-grid-item__triangle{
		border-color: transparent <?php echo esc_attr( codeless_get_mod('primary_color') ) ?> !important;
	}

	.cl-price-list__recommended{
		border-color: <?php echo esc_attr( codeless_get_mod( 'primary_color' ) ) ?> transparent transparent transparent;
	}

	.cl-lightbox-video a i{
		text-shadow: 4px 4px 16px <?php echo esc_attr( codeless_hex2rgba( codeless_get_mod( 'primary_color' ), '0.42' ) ) ?>;
	}

	.woocommerce-page div.product .woocommerce-tabs ul.tabs li.active{
		border-top:1px solid <?php echo esc_attr( codeless_get_mod( 'primary_color' ) ); ?>
	}
