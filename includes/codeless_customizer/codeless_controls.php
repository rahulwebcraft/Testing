		...
		protected function render_content() {
			...
			<label class="element-meta">
				...
				<?php if ( ! empty( $this->description ) ) : ?>
					<span class="description customize-control-description"><?php echo codeless_complex_esc( $this->description ); ?></span>
				<?php endif; ?>
				<input type="hidden" <?php $this->input_attrs(); ?> value="" <?php echo codeless_complex_esc( $this->get_link() ); ?> />
			</label>
