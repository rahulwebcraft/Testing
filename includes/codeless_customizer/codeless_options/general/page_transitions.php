...
Kirki::add_section( 'cl_general_transitions', array(
    'title'          => esc_attr__( 'Page Transitions', 'regn' ),
    'description'    => esc_attr__( 'Options to enable page transitions with various effects', 'regn' ),
    'panel'          => 'cl_general',
    'priority'       => 5,
    'type'			 => '',
    ...
    Kirki::add_field( 'cl_regn', array(
        ...
        'label'    => esc_attr__( 'On/Off Page Transitions', 'regn' ),
    ...
    Kirki::add_field( 'cl_regn', array(
        ...
        'description'       => esc_attr__( 'Page Transition In Effect', 'regn' ),
        'section'     => 'cl_general_transitions',
        'default'     => 'fade-in',
        'priority'    => 10,
        'multiple'    => 1,
    ...
    Kirki::add_field( 'cl_regn', array(
        ...
        'description'    => esc_attr__( 'Page Transition In Duration', 'regn' ),
        'section'  => 'cl_general_transitions',
        'type'     => 'slider',
        'priority' => 10,
        'default'  => 1000,
    ...
    Kirki::add_field( 'cl_regn', array(
        ...
        'description'       => esc_attr__( 'Page Transition Out Effect', 'regn' ),
        'section'     => 'cl_general_transitions',
        'default'     => 'fade-out',
        'priority'    => 10,
        'multiple'    => 1,
    ...
    Kirki::add_field( 'cl_regn', array(
        ...
        'description'    => esc_attr__( 'Page Transition Out Duration', 'regn' ),
        'section'  => 'cl_general_transitions',
        'type'     => 'slider',
        'priority' => 10,
        'default'  => 1000,
