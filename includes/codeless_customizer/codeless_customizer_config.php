...
if( !class_exists( 'CodelessCustomizerConfig' ) ) {
    ...
    class CodelessCustomizerConfig {
        ...
        public function __construct() {
            ...
            add_action( 'after_setup_theme', array( $this, 'font_add_all_variants' ), 100 );
        ...
        function register_preview_scripts() {
            ...
            // Custom CSS for the builder, specifically for this theme
            wp_enqueue_style( 'codeless-custom-framework-css', get_template_directory_uri() . '/css/codeless-framework-custom.css' );
        ...
        public function load_options() {
            ...
            Kirki::add_config( 'cl_regn', array(
            ...
            require_once 'codeless_options/woocommerce.php';
