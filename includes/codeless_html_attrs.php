...
function codeless_manage_body_classes( $classes = '' ) {
    ...
    if( codeless_get_mod( 'header_menu_logo_center', false ) )
        $classes[] = 'cl-header-menu-logo-center';

    if( codeless_get_layout_option( 'page_header_bool') == 'on'  )
        $classes[] = 'cl-with-pageheader';
...
function codeless_extra_classes_header( $classes ) {
    ...
    if( codeless_get_mod( 'header_split_border', 'none' ) != 'none' ){
