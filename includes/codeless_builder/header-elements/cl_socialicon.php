...
<style type="text/css">
	#<?php echo esc_attr( $id ) ?> .cl_socialicon:hover{
		...
		background-color:<?php echo codeless_complex_esc($bgcolor_hover) ?> !important;
		<?php endif; ?>

		<?php if( ! empty( $bcolor_hover ) ): ?>
		border-color: <?php echo codeless_complex_esc($bcolor_hover) ?> !important;
		<?php endif; ?>
	}
	#<?php echo esc_attr( $id ) ?> .cl_socialicon:hover a{
		<?php if( ! empty( $color_hover ) ): ?>
		color: <?php echo codeless_complex_esc($color_hover) ?> !important;
		<?php endif; ?>
	}
</style>
