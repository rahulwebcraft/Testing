...
// Portfolio Entries List: Extra Classes
add_filter( 'codeless_extra_classes_portfolio_entries_list', 'codeless_extra_classes_portfolio_entries_list' );
// Portfolio Entries List: Extra Attributes
add_filter( 'codeless_extra_attr_portfolio_entries_list', 'codeless_extra_attr_portfolio_entries_list' );
