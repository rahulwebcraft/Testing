<div class="wrapper postbox with-pad">
	...
	<div class="inner-wrapper">
		...
		<p>
            <a id="footerSetupBtn" name="<?php esc_attr_e('Select Footer', 'regn') ?>" href="/TB_inline?width=960&height=600&inlineId=importer_footer_dialog"  class="button-primary codeless-hint-qtip thickbox"><?php esc_html_e( 'Footer Wizard', 'regn' ); ?></a>
        </p>
