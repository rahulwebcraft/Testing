<div class="wrapper postbox with-pad">
	...
	<div class="inner-wrapper">
		...
		<p>
            <a id="headerSetupBtn" name="<?php esc_attr_e('Select Header', 'regn') ?>" href="/TB_inline?width=960&height=600&inlineId=importer_header_dialog"  class="button-primary codeless-hint-qtip thickbox"><?php esc_html_e( 'Header Wizard', 'regn' ); ?></a>
        </p>
