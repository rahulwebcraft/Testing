<div class="wrapper postbox with-pad">
	...
	<div class="inner-wrapper">
		...
		<p>
            <a id="setupBtn" name="<?php esc_attr_e('Select Template', 'regn') ?>" href="/TB_inline?width=960&height=600&inlineId=importer_dialog"  class="button-primary codeless-hint-qtip thickbox"><?php esc_html_e( 'Setup Now', 'regn' ); ?></a>
        </p>
