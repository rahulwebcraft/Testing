...
class CodelessContactInfo extends WP_Widget{
    ...
    function widget($atts, $instance){
        ...
        <div class="cl-contact-info">
            ...
            <?php if( !empty( $phone ) ): ?>
            <div class="info"><i class="cl-icon-phone"></i><span><?php echo do_shortcode( $phone ) ?></span></div>
            <?php endif; ?>
    ...
    function form($instance){
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id('address') ); ?>"><?php echo esc_attr__('Address', 'regn') ?>: 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id('email') ); ?>"><?php echo esc_attr__('Email', 'regn') ?>: 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id('phone') ); ?>"><?php echo esc_attr__('Phone', 'regn') ?>: 
